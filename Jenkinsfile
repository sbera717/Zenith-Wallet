pipeline{
    ...
    stages{
      ...
      environment {
        DOCKER_IMAGE = "sbera717/login-service:${BUILD_NUMBER}"
        ...
        steps {
            withCredentials([string(credentialsId: 'github', variable: 'GITHUB_TOKEN')]) {
                sh '''
                    ...
                    git push https://${GITHUB_TOKEN}@github.com/${GIT_USER_NAME}/${GIT_REPO_NAME} HEAD:Login-Service
                '''
            }
        }
    }
